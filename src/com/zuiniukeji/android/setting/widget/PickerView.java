...
public class PickerView extends View
{
	...
	private int mColorText = 0xff00b8ec;
...
//		mMinTextSize = mMaxTextSize / 2f;
	...
	private void drawData(Canvas canvas)
	{
		...
		canvas.drawRect(0, 70, getWidth(), 143, mPaint);
		...
		for(int i=0;i<2;i++){
			canvas.drawLine(0,70+73*i,getWidth(),70+73*i, mPaint);
		}
	}
...
//		canvas.drawLine(0, 80, 184, 80, mPaint);
	}
